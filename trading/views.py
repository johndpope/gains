...
def dashboard(request , id):
        ...
        Quadrigacx_API = get_object_or_404(Trading_Platform , user = request.user, trading_platform=1)
        Quoinex_API = get_object_or_404(Trading_Platform , user = request.user, trading_platform=4)
