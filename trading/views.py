...
def dashboard(request , id):
        Quadrigacx_API = Trading_Platform.objects.get(id=id, trading_platform="Quadrigacx_API")
        Quoinex_API = Trading_Platform.objects.get(id=id, trading_platform="Quoinex_API")
