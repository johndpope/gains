...
def dashboard(request , id):
        ...
        Quadrigacx_API = get_object_or_404(Trading_Platform , user.id = request.user.id, trading_platform="Quadrigacx_API")
        Quoinex_API = get_object_or_404(Trading_Platform , user.id = request.user.id, trading_platform="Quoinex_API")
